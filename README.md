...
1. Cambie a su aplicación Wercker y en la pestaña **Workflows**. Haga clic en Agregar *New Pipeline*.
...
1. Cambie a la pestaña **Runs**. Haga clic en la última tubería de **build** para mostrar su ejecución. Haga click en **Actions** y lueg en ```deploy-to-kubernetes```
El pipeline se inicia y realiza la implementación del contenedor en OKE.
...
    - Tenga en cuenta que el pipeline se ejecutó automáticamente.
    
